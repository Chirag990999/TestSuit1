...
public void openBrowser() {
    ...
    public void userShouldBeRegisterSuccessfully(){
        ...
        //Enter Email
        //driver.findElement( By.xpath( "//input[@name=\"Email\"]" ) ).sendKeys( "Automation@bmail.com" );
        ...
        // driver.findElement( By.xpath( "//input[@name=\"ConfirmPassword\"]" ) ).sendKeys( "Auto123" );
    ...
    public void userShouldEmailTheProductToTheFriendSuccessfully(){
        ...
        //Type and verify Personal Message
        // actualmessage = driver.findElement( By.className( "//textarea[@id=\"PersonalMessage\"]" ) ).getText();
        // expectedmessage = "Hi";
    ...
    public void userShouldBeAbleToSelectAndChangeTheCurrency(){
        ...
        // Select US Dollar from drop down currency menu
